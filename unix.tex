...
プログラム等をつくるとき、UNIX上ではエディタとして \vbindex{emacs}
等を使うことが多い。
...
いろいろなアプリケーションが \vbindex{rpm} 形式と呼ばれる\nmindex{パッ
  ケージ}形式で配布されており、
...
% \begin{itemize}
% \item 
% \url{http://radiofly.to/nishi/cvs/}
% \item 
% \url{http://www.race.u-tokyo.ac.jp/users/moro/cvs/basics.html}
% \end{itemize}
